...
const sendPostRequest = async () => {
  ...
  dataCheckingFormBanner = {
    campaign_name: "survey_baniv_nguoilaodong_20230421", //name của ca
    engagement_type: "1003",
    source_name: "Vnexpress", // Hệ thống tự push vào
    source_type: "internal",
    index_brand: "survey_baniv_nguoilaodong_20230421",
    index_industrial: "",
    index_category: "",
    index_topic: "",
    ...
    .then(function (response) {
      ...
      if (response.status === 201 || response.status === 200) {
        Swal.fire({
          ...
          html:
            "<div class='pop-area'><p>Cảm ơn bạn đã tham gia</p> <p>Bạn có thể chia sẻ khảo sát này cho người khác</p> </br> " +
            '<div class="social-share-pop"> <p class="d-none"></p> <img src="assets/images/facebook.png" class="fb" alt="" /> <img src="assets/images/twiter.png" class="twiter" alt="" /> <img src="assets/images/link.png" class="link-copy" alt="" /> </div></div>',
          focusConfirm: false,
        ...
        dataLayer.push({
          event: "voteEvent",
          vote_category: "survey_baniv_nguoilaodong_20230421",
          vote_action: "survey_baniv_nguoilaodong_20230421",
        });
